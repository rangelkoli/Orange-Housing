        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16'>
          ...
          <div className='lg:col-span-5 space-y-8 '>
            ...
            <p className='text-stone-600 text-base leading-relaxed max-w-md'>
              OrangeHousing.com provides hundreds of real, current, and accurate
              houses, apartments, and condos near Syracuse University, ESF,
              Crouse Hospital, and Upstate Medical in Syracuse, NY.
            </p>
            ...
            <div className='flex items-center gap-4 bg-white p-4 rounded-xl border border-stone-200 shadow-sm w-full'>
              ...
              <div className='space-y-1'>
                <p className='text-xs font-semibold text-[#EB7B07] uppercase tracking-wider'>
                  Certified Business
                </p>
                <p className='text-sm font-medium text-stone-600 leading-tight max-w-[200px]'>
                  Syracuse, NY Certified WBE Homes and Apartments Rental
                  Website.
                </p>
              </div>
            </div>
          ...
          <div className='lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8 lg:pl-12'>
            {/* Support Column */}
            <div>
              <h4 className='font-bold text-stone-900 mb-6 text-lg border-b border-[#EB7B07] inline-block pb-1'>
                Support
              </h4>
              <ul className='space-y-4 text-stone-600'>
                <li>
                  <Link
                    to='#'
                    className='hover:text-[#EB7B07] transition-colors flex items-center gap-2 hover:translate-x-1 duration-200'
                  >
                    Contact Us
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className='flex flex-col gap-4'>
                <p className='text-sm text-stone-600'>
                  Follow us on social media for the latest updates and listings.
                </p>
                <div className='flex gap-3'>
                  <Link
                    to='#'
                    className='bg-white border border-stone-200 p-3 rounded-lg text-stone-500 hover:bg-[#EB7B07] hover:text-white hover:border-[#EB7B07] transition-all duration-300 shadow-sm'
                  >
                    <Facebook size={20} />
                  </Link>
                  <Link
